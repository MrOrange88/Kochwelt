...
function sync_ingredient_7() {
  let input = document.getElementById("portion_value").value;
  let current = Math.max(1, parseInt(input));
...
function sync_ingredient_9() {
  let input = document.getElementById("portion_value").value;
  let current = Math.max(1, parseFloat(input));
  let element = document.querySelector(".ingredient_9");
  let data = element.getAttribute("data-base");
  let data_number = parseFloat(data);
  let result = current * data_number;
  element.textContent = result;
...
function sync_ingredient_10() {
  let input = document.getElementById("portion_value").value;
  let current = Math.max(1, parseFloat(input));
  let element = document.querySelector(".ingredient_10");
  let data = element.getAttribute("data-base");
  let data_number = parseFloat(data);
  let result = current * data_number;
  element.textContent = result;
...
function sync_ingredient_11() {
  let input = document.getElementById("portion_value").value;
  let current = Math.max(1, parseFloat(input));
  let element = document.querySelector(".ingredient_11");
  let data = element.getAttribute("data-base");
  let data_number = parseFloat(data);
  let result = current * data_number;
  element.textContent = result;
...
function sync_ingredient_12() {
  let input = document.getElementById("portion_value").value;
  let current = Math.max(1, parseFloat(input));
  let element = document.querySelector(".ingredient_12");
  let data = element.getAttribute("data-base");
  let data_number = parseFloat(data);
  let result = current * data_number;
  element.textContent = result;
...
function sync_ingredient_13() {
  let input = document.getElementById("portion_value").value;
  let current = Math.max(1, parseFloat(input));
  let element = document.querySelector(".ingredient_13");
  let data = element.getAttribute("data-base");
  let data_number = parseFloat(data);
  let result = current * data_number;
  element.textContent = result;
